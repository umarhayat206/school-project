...
<div class="container-fluid">		
    ...
    <h3>Regiter Student</h3>
    </div><br><br>


<div class="panel panel-default">
  <div class="panel-heading"><h1 class="text-center" >Register Student here</h1></div>
  <div class="panel-body">
     ...
     <form  class="form-horizontal" method="POST" action="user_registration.php">
       
        <div class="form-group">
          <label class="control-label col-sm-2">Student's Name:</label>
           <div class="col-sm-10">
          <input type='text' name='user_name' class="form-control"placeholder="student name">
...
<?php 
	...
	echo "<script>window.open('user_registration.php?school=School Name is required','_self')</script>";
		...
		if($student_roll==''){
	echo "<script>window.open('user_registration.php?roll=Enter roll number','_self')</script>";
		exit;
		}
		if($student_class=='null'){
	echo "<script>window.open('user_registration.php?class=Select class','_self')</script>";
		exit;
		}
