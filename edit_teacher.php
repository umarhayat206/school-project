...
include 'nav.php';
	...
	$query = "select * from teachers where u_id='$edit_record'";
...
<div class="panel panel-default">
  <div class="panel-heading"><h1 class="text-center" >Update Teacher</h1></div>
  <div class="panel-body">



	<form method='POST' action='edit_teacher.php?edit_form=<?php echo $edit_id; ?>' class="form-horizontal">
        ...
        <div class="form-group">
        <label class="control-label col-sm-2">School's Name:</label>
        <div class="col-sm-10">
...
$query1 = "update teachers set u_name='$student_name',u_father='$student_father',u_school='$student_school',
